    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          variants={item}
        >
          <span className="text-white block">Transforming Concepts into Seamless</span>
          <span className="hero-purple-text block mt-1">User Experiences</span>
        </motion.h1>
        <motion.p
        ...
        <motion.div variants={item} className="mt-10">
          <Link href="#projects" className="group hero-cta-btn px-6 py-3 rounded-xl font-medium text-white inline-flex items-center gap-2 hover:shadow-lg hover:shadow-purple-500/10">
            <motion.span
            ...
            >
              See my work
              <motion.span className="inline-block" initial={false} whileHover={{ x: 4 }} transition={spring}>
                →
              </motion.span>
            </motion.span>
          </Link>
